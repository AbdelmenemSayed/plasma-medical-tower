...
const campaignSlides: CampaignSlide[] = [
  ...
  {
    id: 'dr-amr-mostafa',
    doctorName: 'دكتور عمرو مصطفى',
    doctorTitle: 'استشاري جراحة المسالك البولية والتناسلية',
    doctorDegree: 'مدرس جراحة المسالك البولية بكلية طب قصر العيني',
    specialty: 'جراحة المسالك البولية والتناسلية',
    campaignTitle: 'التهاب البروستاتا! محتاج استشارة سريعة',
    campaignSubtitle: 'تشخيص دقيق وعلاج متقدم لالتهابات وتضخم البروستاتا الحميد وجراحات المسالك البولية والتناسلية بأحدث التقنيات',
    imageSrc: '/announcements/banner-dr-amr-mostafa.jpg',
    keyPoints: [
      'تشخيص وعلاج التهابات البروستاتا الحادة والمزمنة',
      'علاج تضخم البروستاتا الحميد بالتبخير والمناظير الدقيقة',
      'فحص تدفق البول وعلاج اضطرابات التبول وسلس البول',
    ],
    themeColor: 'from-blue-950 via-sky-900/80 to-teal-950',
    badgeText: 'استشاري قصر العيني',
    phoneNumbers: ['01021869999', '01035719999', '0238120999'],
    timing: 'عيادات جراحة المسالك البولية والتناسلية',
  },
  {
    id: 'dr-zakaria',
    doctorName: 'دكتور زكريا محيسن',
    doctorTitle: 'استشاري النساء والتوليد',
    doctorDegree: 'استشاري النساء والتوليد بمستشفى الحوامدية العام',
    specialty: 'نساء وتوليد',
    campaignTitle: 'تأخر الحمل مش نهاية الأمل!',
    campaignSubtitle: 'تشخيص دقيق لأسباب تأخر الإنجاب وعلاج تكيس المبايض ومتابعة التبويض بالسونار خطوة بخطوة لحد ما يتحقق الحلم',
    imageSrc: '/announcements/banner-dr-zakaria.jpg',
    keyPoints: [
      'تشخيص وعلاج أسباب تأخر الإنجاب وتأخر الحمل للزوجين',
      'بروتوكولات علاج تكيس المبايض واضطرابات الهرمونات النسائية',
      'متابعة التبويض بالسونار المهبلي وتهيئة الرحم وحدوث الحمل الآمن',
    ],
    themeColor: 'from-teal-950 via-emerald-900/80 to-slate-950',
    badgeText: 'استشاري مستشفى الحوامدية',
    phoneNumbers: ['01021869999', '01035719999', '0238120999'],
    timing: 'عيادات النساء والتوليد وتأخر الإنجاب',
  },
  {
    id: 'dr-dalia',
    doctorName: 'دكتور داليا عبد المحسن',
    doctorTitle: 'دكتوراه التغذية العلاجية — جامعة حلوان',
    doctorDegree: 'مدير إدارة التغذية بمديرية الصحة بالجيزة',
    specialty: 'السمنة والنحافة',
    campaignTitle: 'ثبات الوزن ونزوله بعد الريجيم.. المشكلة في الدايت مش فيك!',
    campaignSubtitle: 'أنظمة غذائية علاجية مخصصة لجسمك وطبيعة حرقك بدون حرمان وبدون رجوع الوزن مرة أخرى',
    imageSrc: '/announcements/banner-dr-dalia.jpg',
    keyPoints: [
      'كسر ثبات الوزن وتنشيط معدل الحرق الأيضي (Metabolism)',
      'أنظمة تغذية علاجية لمرضى السكر والضغط ومقاومة الإنسولين',
      'فحص InBody متقدم وتحليل نسب الدهون والعضلات ومتابعة أسبوعية',
    ],
    themeColor: 'from-cyan-950 via-teal-900/80 to-slate-950',
    badgeText: 'مدير إدارة التغذية بالجيزة',
    phoneNumbers: ['01021869999', '01035719999', '0238120999'],
    timing: 'عيادات السمنة والنحافة والتغذية العلاجية',
  },
  {
    id: 'dr-ahmed-fouly',
    doctorName: 'د. أحمد عصام فولي',
    doctorTitle: 'أخصائي أمراض المخ والأعصاب وفسيولوجيا الأعصاب الإكلينيكية',
    doctorDegree: 'أخصائي الفسيولوجيا العصبية ورسم المخ والأعصاب',
    specialty: 'مخ وأعصاب وفسيولوجيا الأعصاب الإكلينيكية',
    campaignTitle: 'عيادة المخ والأعصاب والفسيولوجيا العصبية',
    campaignSubtitle: 'تشخيص وعلاج الصداع المزمن، آلام والتهابات الأعصاب الطرفية، الدوخة وعدم الاتزان، والتشنجات العصبية',
    imageSrc: '/announcements/banner-dr-ahmed-fouly.jpg',
    keyPoints: [
      'رسم المخ الكهربائي الرقمي (EEG) لتشخيص بؤر الصرع والتشنجات',
      'رسم العضلات وسرعة توصيل الأعصاب (EMG & NCV) لليدين والقدمين',
      'علاج التهابات الأعصاب لمرضى السكر والانزلاق الغضروفي والصداع النصفي',
    ],
    themeColor: 'from-teal-950 via-sky-900/80 to-slate-950',
    badgeText: 'أخصائي المخ والأعصاب',
    phoneNumbers: ['01021869999', '0238120999'],
    timing: 'عيادات المخ والأعصاب ووحدة رسم المخ والعضلات',
  },
];
