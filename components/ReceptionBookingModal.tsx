...
const clinicsList = [
  ...
  { name: 'السمنة والنحافة', doctor: 'دكتور داليا عبد المحسن' },
  { name: 'نساء وتوليد', doctor: 'دكتور زكريا محيسن' },
  { name: 'مخ وأعصاب وفسيولوجيا الأعصاب الإكلينيكية', doctor: 'د. أحمد عصام فولي' },
  { name: 'جراحة المسالك البولية والتناسلية', doctor: 'دكتور عمرو مصطفى' },
