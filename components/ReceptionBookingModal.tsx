...
const clinicsList = [
  ...
  { name: 'مسالك بولية وأمراض ذكورة وعقم', doctor: 'دكتور أحمد مجدي الهواري' },
  { name: 'أخصائي أمراض القلب والأوعية الدموية', doctor: 'دكتور محمد صابر قطب' },
  { name: 'أمراض الدم', doctor: 'د/ دعاء عبد الرازق' },
  { name: 'جراحة عامة ومناظير وجراحة أورام الثدي', doctor: 'دكتور عبد الرحمن الجابري' },
  { name: 'غدد صماء وسكر الأطفال', doctor: 'أ.د. أشرف عبد الفضيل السويفي' },
  { name: 'السمنة والنحافة', doctor: 'أخصائيو التغذية ونحت القوام' },
  { name: 'نساء وتوليد', doctor: 'استشاريات النساء والتوليد' },
  { name: 'مخ وأعصاب وفسيولوجيا الأعصاب الإكلينيكية', doctor: 'وحدة الفسيولوجيا العصبية (رسم مخ وعضلات)' },
  { name: 'جراحة المسالك البولية والتناسلية', doctor: 'جراحو المسالك والبروستاتا' },
  { name: 'الأشعة التشخيصية والسونار', doctor: 'فريق استشاريي الأشعة الرقمية' },
  { name: 'التحاليل الطبية والمعامل', doctor: 'معمل بلازما المعتمد' },
  { name: 'طب وجراحة الأسنان', doctor: 'عيادات الأسنان المتكاملة' },
];
