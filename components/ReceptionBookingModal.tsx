...
const clinicsList = [
  { name: 'القلب والأوعية الدموية', doctor: 'د. أحمد عادل' },
  { name: 'العظام والمفاصل', doctor: 'د. محمد الشاذلي' },
  { name: 'طب الأطفال', doctor: 'د. سارة فتحي' },
  { name: 'الباطنة والسكر', doctor: 'د. إبراهيم فؤاد' },
  { name: 'النساء والتوليد', doctor: 'د. رانيا يوسف' },
  { name: 'الأسنان', doctor: 'د. كريم عبد العزيز' },
];
