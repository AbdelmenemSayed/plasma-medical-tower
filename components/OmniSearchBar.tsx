...
const staffDirectory = [
  ...
  { name: 'د/ خالد مأمون مؤنس', role: 'مدرس واستشاري جراحة المخ والأعصاب والعمود الفقري (قصر العيني)', branch: 'الحوامدية', section: 'عيادة الطبيب' },
  { name: 'أ.د. أشرف عبد الفضيل السويفي', role: 'أستاذ واستشاري الغدد الصماء وسكر الأطفال', branch: 'الحوامدية', section: 'عيادة الطبيب' },
  { name: 'دكتور عبد الرحمن الجابري', role: 'مدرس مساعد الجراحة العامة والمناظير وجراحة أورام الثدي', branch: 'الحوامدية', section: 'عيادة الطبيب' },
  { name: 'دكتور أحمد مجدي الهواري', role: 'استشاري جراحة المسالك البولية وأمراض الذكورة والعقم', branch: 'الحوامدية', section: 'عيادة الطبيب' },
  { name: 'د/ دعاء عبد الرازق', role: 'استشاري أمراض الدم', branch: 'الحوامدية', section: 'عيادة الطبيب' },
  { name: 'دكتور محمد صابر قطب', role: 'أخصائي أمراض القلب والأوعية الدموية', branch: 'الحوامدية', section: 'عيادة الطبيب' },
  { name: 'دكتور حسين الشوري', role: 'استشاري الأمراض الباطنية والسكر والسمنة والجهاز الهضمي', branch: 'الحوامدية', section: 'عيادة الطبيب' },
  { name: 'دكتور عادل عبد المنعم يونس', role: 'استشاري الجراحة العامة وجراحة الأوعية الدموية', branch: 'الحوامدية', section: 'عيادة الطبيب' },
  { name: 'دكتور عمرو مصطفى', role: 'مدرس واستشاري جراحة المسالك البولية والتناسلية (قصر العيني)', branch: 'الحوامدية', section: 'عيادة الطبيب' },
  { name: 'دكتور زكريا محيسن', role: 'استشاري النساء والتوليد وتأخر الإنجاب (مستشفى الحوامدية العام)', branch: 'الحوامدية', section: 'عيادة الطبيب' },
  { name: 'دكتور داليا عبد المحسن', role: 'دكتوراه التغذية العلاجية ومدير إدارة التغذية بالجيزة', branch: 'الحوامدية', section: 'عيادة الطبيب' },
  { name: 'د. أحمد عصام فولي', role: 'أخصائي أمراض المخ والأعصاب وفسيولوجيا الأعصاب الإكلينيكية', branch: 'الحوامدية', section: 'عيادة الطبيب' },
...
const clinicsList = [
  { name: 'عيادة أمراض الباطنة والسكر والسمنة والجهاز الهضمي', doctor: 'دكتور حسين الشوري', fee: '400 جنيه' },
  { name: 'عيادة المخ والأعصاب وجراحة العمود الفقري', doctor: 'د/ خالد مأمون مؤنس', fee: '500 جنيه' },
  { name: 'عيادة جراحة عامة وجراحة أوعية دموية (علاج الدوالي)', doctor: 'دكتور عادل عبد المنعم يونس', fee: '450 جنيه' },
  { name: 'عيادة مسالك بولية وأمراض ذكورة وعقم', doctor: 'دكتور أحمد مجدي الهواري', fee: '400 جنيه' },
  { name: 'عيادة أمراض القلب والأوعية الدموية', doctor: 'دكتور محمد صابر قطب / د. أحمد عادل', fee: '450 جنيه' },
  { name: 'عيادة أمراض الدم', doctor: 'د/ دعاء عبد الرازق', fee: '400 جنيه' },
  { name: 'عيادة جراحة عامة ومناظير وجراحة أورام الثدي', doctor: 'دكتور عبد الرحمن الجابري', fee: '500 جنيه' },
  { name: 'عيادة غدد صماء وسكر الأطفال', doctor: 'أ.د. أشرف عبد الفضيل السويفي', fee: '450 جنيه' },
  { name: 'عيادة السمنة والنحافة والتغذية العلاجية', doctor: 'دكتور داليا عبد المحسن', fee: '300 جنيه' },
  { name: 'عيادة النساء والتوليد ورعاية الأجنة', doctor: 'دكتور زكريا محيسن', fee: '350 جنيه' },
  { name: 'وحدة مخ وأعصاب وفسيولوجيا الأعصاب الإكلينيكية (رسم مخ وعضلات)', doctor: 'د. أحمد عصام فولي', fee: 'حسب الفحص' },
  { name: 'عيادة جراحة المسالك البولية والتناسلية', doctor: 'دكتور عمرو مصطفى', fee: '450 جنيه' },
  { name: 'قسم التحاليل وسحب العينات المنزلي', doctor: 'معمل بلازما الرقمي', fee: 'حسب الفحص' },
  { name: 'قسم الأشعة الرقمية والسونار والدوبلر', doctor: 'وحدة الأشعة المتقدمة', fee: 'حسب الفحص' },
  { name: 'عيادات طب وجراحة الأسنان', doctor: 'فريق جراحة الأسنان', fee: 'حسب الإجراء' },
];
