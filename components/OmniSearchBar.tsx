...
const clinicsList = [
  ...
  { name: 'عيادة مسالك بولية وأمراض ذكورة وعقم', doctor: 'نخبة الاستشاريين', fee: '400 جنيه' },
  { name: 'عيادة أمراض القلب والأوعية الدموية', doctor: 'د. أحمد عادل', fee: '450 جنيه' },
  { name: 'عيادة أمراض الدم', doctor: 'استشاريو أمراض الدم', fee: '400 جنيه' },
  { name: 'عيادة جراحة عامة ومناظير وجراحة أورام الثدي', doctor: 'وحدة جراحة الأورام', fee: '500 جنيه' },
  { name: 'عيادة غدد صماء وسكر الأطفال', doctor: 'د. سارة فتحي', fee: '350 جنيه' },
