...
const clinicsList = [
  ...
  { name: 'عيادة السمنة والنحافة والتغذية العلاجية', doctor: 'أخصائيو التغذية', fee: '300 جنيه' },
  { name: 'عيادة النساء والتوليد ورعاية الأجنة', doctor: 'استشاريات النساء', fee: '350 جنيه' },
  { name: 'وحدة مخ وأعصاب وفسيولوجيا الأعصاب الإكلينيكية (رسم مخ وعضلات)', doctor: 'وحدة الفسيولوجيا العصبية', fee: 'حسب الفحص' },
  { name: 'عيادة جراحة المسالك البولية والتناسلية', doctor: 'جراحو المسالك', fee: '450 جنيه' },
